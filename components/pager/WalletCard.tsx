      ...
      >
        <View style={styles.topSection}>
          <View>
            ...
            <DynamicText fontWeight="bold" style={styles.balance}>
              {selectedCountry === "MM"
          ...
          <TouchableOpacity activeOpacity={0.8} style={styles.topUpBtn} onPress={() => router.navigate("/home/balance/topup")}>
            <View style={styles.iconCircle}>
              <Ionicons name="wallet" size={20} color="#991b1b" />
            </View>
            <DynamicText fontWeight="bold" style={styles.topUpText}>ငွေဖြည့်ရန်</DynamicText>
          </TouchableOpacity>
        </View>
        ...
        <View style={styles.bottomSection}>
          <TouchableOpacity activeOpacity={0.6} style={styles.actionBtn}>
            ...
            <DynamicText style={styles.actionText}>အော်ဒါမှတ်တမ်း</DynamicText>
          </TouchableOpacity>
          ...
          <TouchableOpacity activeOpacity={0.6} style={styles.actionBtn}>
            ...
            <DynamicText style={styles.actionText}>ငွေဖြည့်မှတ်တမ်း</DynamicText>
          </TouchableOpacity>
        </View>
