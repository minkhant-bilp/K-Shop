  ...
  return (
   <SafeAreaView className='flex-1 bg-white'>
     ...
     <VStack className='flex-1 mt-4 px-6'>
      ...
      <Text allowFontScaling={false} className='text-sky-400 underline font-medium'>Sign in</Text>
      </HStack>
      <VStack className='mb-5'>
        ...
        <FormControl  isInvalid={!passwordsMatch && confirmPassword.length > 0} className="mb-8">
