...
const Deposit = () => {
    ...
    const getImageForMethod = (title: string) => {
        ...
        if (title.includes("Wave")) return require('@/assets/game_image/kbz.png');
        return require('@/assets/game_image/wave.png'); // Default
    };
    ...
    const renderItem = ({ item }: { item: any }) => {
        ...
        const displayAmount = `+${item.amount.toLocaleString()} ${item.currency}`;
        const displayImage = getImageForMethod(item.title);
            ...
            <View style={styles.card}>
                <View style={styles.cardTop}>
                    ...
                    <View style={{ flex: 1, marginLeft: 12 }}>
                        ...
                        <Text style={styles.txnId}>TXN-{item.id.slice(-6)}</Text>
                    </View>
